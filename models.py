...
class Canasta(models.Model):
    id_canasta = models.AutoField(db_column='ID_Canasta', primary_key=True)  # Field name made lowercase.
    nombre = models.CharField(db_column='Nombre', max_length=50)  # Field name made lowercase.
    descripcion = models.CharField(db_column='Descripcion', max_length=200)  # Field name made lowercase.
    precio = models.DecimalField(db_column='Precio', max_digits=5, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    fk_canastaproductos = models.IntegerField(db_column='fk_canastaProductos', blank=True, null=True)  # Field name made lowercase.
...
class Canastaproductos(models.Model):
    id_canasta = models.OneToOneField(Canasta, models.DO_NOTHING, db_column='id_canasta', primary_key=True)  # The composite primary key (id_canasta, id_producto) found, that is not supported. The first column is selected.
